...
class SerializableMeshInfo
{
    ...
    {
        vertices = new SerializableVector3[m.vertexCount]; // initialize vertices array.
    ...
    public Mesh GetMesh()
    {
        ...
        {
            verticesList.Add(new Vector3(vertices[i].x, vertices[i].y,vertices[i].z));
        }
